...
const rollupFeature = config.features.rollup;
 ...
 type Props = { item: PlatonL2WithdrawalsItem; isLoading?: boolean };

const PlatonL2WithdrawalsTableItem = ({ item, isLoading }: Props) => {
...
export default PlatonL2WithdrawalsTableItem;
